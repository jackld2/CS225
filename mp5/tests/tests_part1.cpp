...
//   KDTree<3> tree(pts);
//
//   pts.push_back(Point<3>(4,5,5));
//   pts.push_back(Point<3>(1,3,5));
//   pts.push_back(Point<3>(3,6,5));
//   pts.push_back(Point<3>(2,4,5));
//   pts.push_back(Point<3>(0,2,5));
//
//   for (auto pt: pts) {
//     cout<<pt;
//   }
//   cout<<endl;
//   int a  = tree.partition(pts, 0, 4, 2, 0 );
//   cout<<endl;
//
//   for (auto pt: pts) {
//     cout<<pt;
...
// TEST_CASE("KDTree::select", "[weight=1][part=1]") {
//   vector<Point<3>> pts;
//   KDTree<3> tree(pts);
//
//   pts.push_back(Point<3>(4,5,5));
...
//   pts.push_back(Point<3>(2,4,5));
//   pts.push_back(Point<3>(0,2,5));
//   pts.push_back(Point<3>(5,2,5));
//
//   for (auto pt: pts) {
//     cout<<pt;
//   }
//   cout<<endl;
//   Point<3> a  = tree.select(pts, 0, 5, 2, 0 );
//   cout<<endl;
//
//   for (auto pt: pts) {
//     cout<<pt;
